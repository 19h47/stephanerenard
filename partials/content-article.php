<article class="col-xs-10 col-xs-offset-1 col-sm-offset-0 col-sm-4">
    <div class="actuality__article">
        <header class="actuality__article__header">
        	<a href="<?php the_permalink(); ?>" class="display-block w-xs-100 h-xs-100 is-on-top js-animation-slide">
                ...
                the_post_thumbnail(
                    ...
                    <div class="img-fluid site-section__article__img"></div>
                <?php endif; ?>
    		</a>
    	</header>
		<div class="actuality__article__content">
        	<a class="actuality__article__content__title h4 color-blue-very-dark uppercase is-on-top" href="<?php the_permalink(); ?>">
        		<?php the_title(); ?>
        	</a>
